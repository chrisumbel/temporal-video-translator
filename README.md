...
- [Computing the Null Space of a Matrix PDF](https://tvttranslations.blob.core.windows.net/pdf/video-translator-nullspace.mp4-d3e1dc10-nullspace.pdf) ([json](https://tvttranslations.blob.core.windows.net/json/video-translator-nullspace.mp4-d3e1dc10-nullspace.json), [source video](https://s3.us-east-1.amazonaws.com/blobs.chrisumbel.com/nullspace.mp4)) — a linear algebra lecture on finding the null space of a matrix by row reduction to RREF and reading off the special solutions.
- [The Agora and Athenian Democracy PDF](https://tvttranslations.blob.core.windows.net/pdf/video-translator-agora.mp4-b1a3fe75-agora.pdf) ([json](https://tvttranslations.blob.core.windows.net/json/video-translator-agora.mp4-b1a3fe75-agora.json), [source video](https://s3.us-east-1.amazonaws.com/blobs.chrisumbel.com/agora.mp4)) — a history piece on the Athenian agora and the workings (and limits) of direct democracy in 5th-century BCE Athens.
- [Integration as the Reverse of Differentiation PDF](https://tvttranslations.blob.core.windows.net/pdf/video-translator-integrals.mp4-f2512f31-integrals.pdf) ([json](https://tvttranslations.blob.core.windows.net/json/video-translator-integrals.mp4-f2512f31-integrals.json), [source video](https://s3.us-east-1.amazonaws.com/blobs.chrisumbel.com/integrals.mp4)) — a calculus lecture on integration as the reverse of differentiation, building the integral as the limit of summed areas under a curve.
- [Coolidge on Taxes and Government Spending PDF](https://tvttranslations.blob.core.windows.net/pdf/video-translator-coolidge.mp4-a1cbb11d-coolidge.pdf) ([json](https://tvttranslations.blob.core.windows.net/json/video-translator-coolidge.mp4-a1cbb11d-coolidge.json), [source video](https://s3.us-east-1.amazonaws.com/blobs.chrisumbel.com/coolidge.mp4)) — a Calvin Coolidge address on the tax burden of government spending and the case for cutting public expenses.
